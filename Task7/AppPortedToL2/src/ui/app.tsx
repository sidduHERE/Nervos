...
export function App() {
    ...
    const [Layer2DepositAddress, setDepositAddress] = useState<string | undefined>();
    ...
    useEffect(() => {
        if (accounts?.[0]) {
            ...
            setDepositAddress(addressTranslator.getLayer2DepositAddress(web3,accounts?.[0]));
        } else {
    ...
    return (
        <div>
            ...
            <br />
            <br />
            Your deposit address: <b>{Layer2DepositAddress || ' - '}</b>
            <br />
            <br />
            ...
            <br />
            <br />
            Current contract address you wish to vote: <b>{contract?.address || '-'}</b> <br />
            <br />
            <hr />
            <p>
            The button below will deploy a eth voting smart contract where any one can do a weighted vote to any existing contract.
				. After the contract is deployed you can either
                read number of votes from smart contract or do a weighted vote. You can do that using the
                interface below.
            </p>
