...
const SudtERC20ProxyJSON = __importStar(require("../../../build/contracts/SudtERC20Proxy.json"));
...
class SimpleStorageWrapper {
    constructor(web3) {
        ...
        this.anothercontract = new web3.eth.Contract(SudtERC20ProxyJSON.abi);
    }
    get isDeployed() {
    ...
    async getckethbalance(polyjuiceAddress, fromAddress) {
